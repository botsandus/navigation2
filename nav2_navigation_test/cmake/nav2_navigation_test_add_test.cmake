...
#
# Usage:
#   find_package(nav2_navigation_test REQUIRED)  # auto-loaded via CONFIG_EXTRAS
#
#   nav2_navigation_add_test(my_mppi_loopback_test
#     SIM_TYPE loopback
...
# @public
#
function(nav2_navigation_add_test NAV_TEST_NAME)
  ...
  # 1. Includes the navigation_test.launch.py from nav2_navigation_test
...
"# Auto-generated by nav2_navigation_add_test(${NAV_TEST_NAME})
import os
import sys
import unittest
...
from launch.launch_description_sources import PythonLaunchDescriptionSource as python_launch_description_source
...
def generate_test_description():
    ...
    nav_stack = IncludeLaunchDescription(
      python_launch_description_source(launch_file),
        launch_arguments=[
${_launch_args}        ],
    )
    ...
    test_runner = launch.actions.ExecuteProcess(
        cmd=[
            sys.executable, '-m', 'nav2_navigation_test.test_runner',
            ${_runner_args_py},
        ],
        output='screen',
    )
