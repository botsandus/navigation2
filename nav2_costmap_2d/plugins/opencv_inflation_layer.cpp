...
OpenCVInflationLayer::OpenCVInflationLayer()
: inflation_radius_(0),
  inscribed_radius_(0),
...
void
OpenCVInflationLayer::onInitialize()
{
...

  {
    ...
    dyn_params_handler_ = node->add_on_set_parameters_callback(
      std::bind(
        &OpenCVInflationLayer::dynamicParametersCallback,
...
void
OpenCVInflationLayer::matchSize()
{
...
void
OpenCVInflationLayer::updateBounds(
...
void
OpenCVInflationLayer::onFootprintChanged()
{
  std::lock_guard<Costmap2D::mutex_t> guard(*getMutex());
  ...
  RCLCPP_DEBUG(
    logger_, "OpenCVInflationLayer::onFootprintChanged(): num footprint points: %zu,"
...
void
OpenCVInflationLayer::computeCaches()
{
  std::lock_guard<Costmap2D::mutex_t> guard(*getMutex());
